...
fig$layout$margin$l <- fig$layout$margin$l + 30
...
There is a positive relationship between self-esteem and: 
...
The statistical tests were done using the IBM SPSS 25 software. A one-tailed Pearson’s correlational test was conducted for the sub-hypotheses and a two-tailed Pearson’s correlational rest was conducted for the other Spotify API features. The alpha level used was 0.05. 

There was a significant correlation between self-esteem and valence, r = .226, p = 0.047. The correlations between self-esteem and the other features were all non-significant, p > .136. The correlation between self-esteem and general musical sophistication was also non-significant, p = .128.
