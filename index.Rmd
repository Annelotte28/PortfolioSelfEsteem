...
# Make the plot
ggplot(data1, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3, fill=Type)) +
  geom_rect() +
  geom_text( x=5, aes(y=labelPosition, label=label), size=4) +
