...
genderplot <- ggplot(data = data_df, aes(x = data_df$demographics.age, y = data_df$rse_score, col = data_df$demographics.gender)) + geom_point() + geom_smooth() + theme_classic() + xlab('Age') + ylab('RSE Score') + ggtitle('RSE scores per gender') + theme(legend.title = element_blank())
